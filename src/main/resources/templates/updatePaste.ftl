...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <form action="/paste/modify/${paste.getId()}" method="post">
            <div class="row">
                <div class="col-md-offset col-md-7">
                    <div class="form-group">
                        <label for="title">Title</label>
                        <input type="text" class="form-control" name="title" value="${paste.getTitulo()}" id="title" placeholder="Enter the Paste title here">
                    </div>
                    <div class="form-group">
                        <label for="bloqueDeTexto">New Paste</label>
                        <textarea class="form-control" placeholder="Enter text to paste" name="bloqueDeTexto" id="bloqueDeTexto" cols="50" rows="20">${paste.bloqueDeCodigo()}
                                  </textarea>
                    </div>
                </div>
                <div class="col-md-5">
